...
const computed = mapState("yard", {
	...
	width: (state) => state.editingZone.PosXMax - state.editingZone.PosXMin,
	length: (state) => state.editingZone.PosYMax - state.editingZone.PosYMin,
	height: (state) => state.editingZone.PosZMax - state.editingZone.PosZMin,
});
