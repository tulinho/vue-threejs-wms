...
// Code is generated on: 5/4/2021 4:14:28 PM
//
...
namespace YmModel
{
    ...
    public partial class TrackZone : EntityObject    {
        ...
        /// <param name="modifLast">Initial value of ModifLast.</param>
        /// <param name="maxStress">Initial value of MaxStress.</param>
        /// <param name="maxHeight">Initial value of MaxHeight.</param>
        public static TrackZone CreateTrackZone(int idZone, string zone, string zoneType, string yard, int status, int posXMin, int posXMax, int posYMin, int posYMax, int posZMin, int posZMax, int pieceCountMax, int priority, int xAlignment, int yAlignment, int rotateAngle, int tiltAngle, bool genEventEnter, bool genEventExit, global::System.DateTime modifLast, int maxStress, int maxHeight)
        {
            ...
            trackZone.MaxStress = maxStress;
            trackZone.MaxHeight = maxHeight;
            return trackZone;
        }
        ...
        /// <summary>
        /// Max pile weight per Kg/m²
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual int MaxStress
        {
            get
            {
                int value = _MaxStress;
                OnGetMaxStress(ref value);
                return value;
            }
            set
            {
                if (_MaxStress != value)
                {
                  OnMaxStressChanging(ref value);
                  ReportPropertyChanging("MaxStress");
                  _MaxStress = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("MaxStress");
                  OnMaxStressChanged();
              }
            }
        }
        private int _MaxStress = 300000;
        partial void OnGetMaxStress(ref int value);
        partial void OnMaxStressChanging(ref int value);
        partial void OnMaxStressChanged();
        ...
        public virtual int MaxHeight
        {
            get
            {
                int value = _MaxHeight;
                OnGetMaxHeight(ref value);
                return value;
            }
            set
            {
        ...
        private int _MaxHeight = 2500;
        partial void OnGetMaxHeight(ref int value);
        partial void OnMaxHeightChanging(ref int value);
    ...
    public partial class TrackZonesPiece : EntityObject    {
        ...
        /// <param name="idPiece">Initial value of IdPiece.</param>
        /// <param name="idZone">Initial value of IdZone.</param>
        /// <param name="idRule">Initial value of IdRule.</param>
        /// <param name="modifLast">Initial value of ModifLast.</param>
        public static TrackZonesPiece CreateTrackZonesPiece(string idPiece, int idZone, decimal idRule, global::System.DateTime modifLast)
        {
            TrackZonesPiece trackZonesPiece = new TrackZonesPiece();
            trackZonesPiece.IdPiece = idPiece;
            trackZonesPiece.IdZone = idZone;
            trackZonesPiece.IdRule = idRule;
        ...
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual decimal IdRule
        {
            get
            {
                decimal value = _IdRule;
                OnGetIdRule(ref value);
                return value;
            }
            set
            {
        ...
        private decimal _IdRule = 1m;
        partial void OnGetIdRule(ref decimal value);
        partial void OnIdRuleChanging(ref decimal value);
